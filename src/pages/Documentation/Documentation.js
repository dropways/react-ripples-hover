...
import Termynal from "../../assets/module/Termynal";
...
export default TypesExample;`;
	...
	useEffect(() => {
		...
		const termynal2 = new Termynal("#termynal2", { startDelay: 600 });
		return () => {};
	}, []);
	...
	return (
		<div className="documentation-wrap">
			<div className="container">
				...
				<div className="preview-box mb-32">
					<div className="preview-header">npm</div>
					<div className="preview-body">
						<div id="termynal" data-ty-startDelay="600">
							<span data-ty="input">npm install react-ripples-hover</span>
							<span data-ty data-ty-delay="0">
								<br />
							</span>
				...
				<div className="preview-box mb-32">
					<div className="preview-header">yarn</div>
					<div className="preview-body">
						<div id="termynal2" data-ty-startDelay="600">
							<span data-ty="input">yarn add react-ripples-hover</span>
							<span data-ty data-ty-delay="0">
								<br />
							</span>
							<span data-ty="progress"></span>
				...
				<div className="preview-box mb-32">
					<div className="preview-header">Usage</div>
					<div className="preview-body">
				...
				<div className="preview-box mb-32">
					<div className="preview-header">Component props</div>
					<div className="preview-body">
								...
								<table className="table">
									...
									<tbody>
										...
										<tr>
											...
											<td className="text-center">Null</td>
											<td className="text-center">
												<div className="optional-value false">
													<IconCircleX />
												</div>
											</td>
										</tr>
